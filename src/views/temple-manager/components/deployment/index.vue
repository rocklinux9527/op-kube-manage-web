<template>
  <div class="app-container">
    ...
    <!-- <DataTable /> -->
     ...
     <!-- <data-table  @titleChanged="handleTitleChanged" :get-temple-list="getTempleLIst" /> -->
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
       ...
       <el-form-item label="类型:" prop="t_type" >
        <el-select placeholder="请选择" v-model="postFrom.t_type" disabled clearable class="filter-item"  style="width: 420px">
          <el-option
            :key="item.key"
            :label="item.key"
            :value="item.value"
        ...
        <el-form-item label="语言" prop="language">
          <el-select v-model="postFrom.language" disabled  placeholder="请选择" clearable class="filter-item" style="width: 420px">
         <el-option
            :key="item"
            :label="item"
            :value="item"
...
export default {
  ...
  data() {
    ...
    typeArray: [  
      {value: 'deployment', key: 'deployment'},
    ],
    cmOptions: {
      // <!-- 以什么格式进行高亮 -->
      mode: "yaml",
