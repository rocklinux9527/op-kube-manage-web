<template>
  ...
  <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="应用模板" name="first">
         <el-input
      ...
      <el-button class="filter-item" style="margin-left: 780px;" type="primary" icon="el-icon-edit" @click="handleCreate">
        新建
      </el-button>    
      <el-table
      :key="tableKey"
    ...
    <el-dialog :visible.sync="dialogPvVisible" title="Reading statistics">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-tab-pane label="Deployment模板" name="second">Deployment模板</el-tab-pane>
        <el-tab-pane label="Service模板" name="third">Service模板</el-tab-pane>
        <el-tab-pane label="Ingress模板" name="fourth">Ingress模板</el-tab-pane>
  </el-tabs>

   
    </div>
    <!-- <div v-show="activeName==='first'">121</div>
    <div v-show="activeName==='second'">123</div> -->
  </div>
